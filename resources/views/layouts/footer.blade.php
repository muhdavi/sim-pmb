...
<footer id="footer">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-4 footer-contact">
                    <h3><img src="{{ asset('assets/img/logo-simpmb-putih.png') }}" alt="" class="img-fluid"></h3>
                    {{--<p>
                        Jl. Banda Aceh - Medan KM 370 Idi Rayeuk Aceh Timur Aceh 24452<br><br>
                        <strong>Phone:</strong> +62 852 3172 9321<br>
                        <strong>Email:</strong> info@gif.or.id<br>
                    </p>--}}
                </div>
    ...
    <div class="container d-md-flex py-4">
        ...
        <div class="mr-md-auto text-center text-md-left">
            <div class="copyright">
                &copy; Copyright <strong><span>SIMPMB</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
